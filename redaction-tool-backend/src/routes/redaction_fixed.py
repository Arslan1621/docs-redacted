...
def download_redacted(format_type, filename):
    ...
    try:
        if format_type == 'docx':
            return download_docx_fixed(filepath, redactions, filename)
        else:
            return download_pdf_fixed(filepath, redactions, filename)
...
def download_docx_fixed(filepath, redactions, original_filename):
...
def download_pdf_fixed(filepath, redactions, original_filename):
